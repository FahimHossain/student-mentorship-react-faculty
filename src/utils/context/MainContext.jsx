...
export default function MainContext(props) {
    ...
    const [task_list, task_listDispatch] = useReducer(ListReducer, initListState);

    const global_state = {
        auth, list, app,skill_list,subSkill_list,question_list,task_list
    }
    const global_dispatch = {
        authDispatch, listDispatch, appDispatch,skill_listDispatch,subSkill_listDispatch,question_listDispatch, task_listDispatch
    }
