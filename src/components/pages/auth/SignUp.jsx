        ...
        <div className="auth">
            <div className="inner">
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <Input name="room_number" type="number" title="Room Number" value={dept.room_number} onChange={onChange} />
                    ...
                    <p className="forgot-password text-right">
                        Already registered <Link to={URL.SIGN_IN}>log in?</Link>
                    </p>
                </form>
            </div>
        </div >
